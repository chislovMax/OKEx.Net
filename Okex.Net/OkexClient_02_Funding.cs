...
namespace Okex.Net
{
    public partial class OkexClient : IOkexClientFunding
    {
        ...
        /// <param name="ct">Cancellation Token</param>
        /// <returns></returns>
        public virtual WebCallResult<OkexFundingUserId> Funding_GetUserID(CancellationToken ct = default) => Funding_GetUserID_Async(ct).Result;
        /// <summary>
        /// Get the unique UID of the account?
        /// Rate Limit: 1 requests per second
        /// </summary>
        /// <param name="ct">Cancellation Token</param>
        /// <returns></returns>
        public virtual async Task<WebCallResult<OkexFundingUserId>> Funding_GetUserID_Async(CancellationToken ct = default)
        {
